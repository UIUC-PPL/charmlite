...
public:
    ...
    status& get_status(
        cmk::collection_index_t idx, detection_message* msg = nullptr)
    {
        ...
        else
        {
            ...
            this->element_proxy()
                .contribute<count_message,
                    cmk::add<typename count_message::type>>(count, cb);
        }
    }
...
void resume_main_(cmk::message* msg)
{
    CthAwaken(th);
}
